...
public class parklistexample extends AppCompatActivity {
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parklistexample);

        ActivityCompat.requestPermissions(parklistexample.this, permissions(), REQUEST_CODE);
